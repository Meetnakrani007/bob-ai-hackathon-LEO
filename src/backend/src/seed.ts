...
export async function seedDatabase(): Promise<void> {
  ...
  // Add completed / delivered consignments (Safe, 0 Risk, successfully completed)
  const deliveredShipments = [
    {
      shipment_id: 'SHP-CMP-9001',
      tracking_number: 'TRK-SG-2026-DEL-9001',
      title: 'Emergency Biologics & Specialty Oncology Batch D-12',
      origin_port_id: 'SGSIN',
      destination_port_id: 'INNSA',
      destination_name: 'AIIMS Central Depot (via JNPT Express Rail Corridor)',
      current_location: { lat: 28.5672, lng: 77.2100 },
      current_route_id: 'RTE-SIN-NSA-SEA',
      cargo_type: 'pharmaceuticals' as const,
      cargo_description: 'Oncology therapeutics delivered under uninterrupted +4.1°C cold chain',
      container_id: 'CONT-REEFER-9101',
      value_usd: 1850000,
      weight_kg: 6200,
      deadline: new Date(now - 12 * 3600 * 1000),
      eta: new Date(now - 14 * 3600 * 1000),
      priority: 'critical' as const,
      requires_refrigeration: true,
      target_temp_min: 2.0,
      target_temp_max: 8.0,
    ...
    {
      shipment_id: 'SHP-CMP-9002',
      tracking_number: 'TRK-SG-2026-DEL-9002',
      title: 'Semiconductor Micro-controllers & Silicon Wafers',
      origin_port_id: 'SGSIN',
      destination_port_id: 'INMAA',
      destination_name: 'Foxconn Sriperumbudur Assembly Complex, Chennai',
      current_location: { lat: 12.9815, lng: 79.9722 },
      current_route_id: 'RTE-SIN-MAA-SEA',
      cargo_type: 'electronics' as const,
      cargo_description: 'A-grade silicon wafers and high-precision microprocessors',
      container_id: 'CONT-DRY-9102',
      value_usd: 2400000,
      weight_kg: 4800,
      deadline: new Date(now - 8 * 3600 * 1000),
      eta: new Date(now - 10 * 3600 * 1000),
      priority: 'high' as const,
      requires_refrigeration: false,
      status: 'delivered' as const,
      risk_score: 0,
    ...
    {
      shipment_id: 'SHP-CMP-9003',
      tracking_number: 'TRK-SG-2026-DEL-9003',
      title: 'EV Lithium-Ion Battery Traction Packs',
      origin_port_id: 'AEJEA',
      destination_port_id: 'INMUN',
      destination_name: 'Tata Motors Sanand EV Gigafactory',
      current_location: { lat: 22.9868, lng: 72.3812 },
      current_route_id: 'RTE-JEA-MUN-SEA',
      cargo_type: 'automotive' as const,
      cargo_description: 'Automotive grade 80kWh prismatic battery modules',
      container_id: 'CONT-DRY-9103',
      value_usd: 950000,
      weight_kg: 26000,
      deadline: new Date(now - 20 * 3600 * 1000),
      eta: new Date(now - 22 * 3600 * 1000),
      priority: 'high' as const,
      requires_refrigeration: false,
      status: 'delivered' as const,
      risk_score: 2,
    ...
    {
      shipment_id: 'SHP-CMP-9004',
      tracking_number: 'TRK-SG-2026-DEL-9004',
      title: 'GI-Tagged Alphonso Mango Consignment (Cold-Chain)',
      origin_port_id: 'INNSA',
      destination_port_id: 'AEJEA',
      destination_name: 'Al Aweer Fruit & Vegetable Market, Dubai',
      current_location: { lat: 25.1610, lng: 55.3780 },
      current_route_id: 'RTE-NSA-JEA-SEA',
      cargo_type: 'perishables' as const,
      cargo_description: 'Export-grade fresh mangoes kept at 12°C controlled atmosphere',
      container_id: 'CONT-REEFER-9104',
      value_usd: 380000,
      weight_kg: 18500,
      deadline: new Date(now - 6 * 3600 * 1000),
      eta: new Date(now - 8 * 3600 * 1000),
      priority: 'medium' as const,
      requires_refrigeration: true,
      target_temp_min: 10.0,
      target_temp_max: 13.0,
      ...
      risk_score: 0,
      risk_factors: [],
      carrier_id: 'CAR-HAPAG',
      reroute_history: [],
    },
    {
      shipment_id: 'SHP-CMP-9005',
      tracking_number: 'TRK-SG-2026-DEL-9005',
      title: 'Precision CNC Robotic Milling Centers',
      origin_port_id: 'SGSIN',
      destination_port_id: 'INNSA',
      destination_name: 'Bharat Forge Precision Engineering Hub, Pune',
      current_location: { lat: 18.5204, lng: 73.8567 },
      current_route_id: 'RTE-SIN-NSA-SEA',
      cargo_type: 'general' as const,
      cargo_description: '5-Axis industrial computerized machining tooling',
      container_id: 'CONT-DRY-9105',
      value_usd: 720000,
      weight_kg: 22400,
      deadline: new Date(now - 18 * 3600 * 1000),
      eta: new Date(now - 24 * 3600 * 1000),
      priority: 'medium' as const,
      requires_refrigeration: false,
      status: 'delivered' as const,
    ...
    {
      shipment_id: 'SHP-CMP-9006',
      tracking_number: 'TRK-SG-2026-DEL-9006',
      title: 'Pediatric Hexavalent Vaccines (2°C - 8°C)',
      origin_port_id: 'SGSIN',
      destination_port_id: 'INNSA',
      destination_name: 'National Vaccine Cold Storage Center, Gwalior',
      current_location: { lat: 26.2183, lng: 78.1828 },
      current_route_id: 'RTE-SIN-NSA-SEA',
      cargo_type: 'pharmaceuticals' as const,
      cargo_description: 'WHO-prequalified multi-valent vaccines delivered via temperature-logged reefer container',
      container_id: 'CONT-REEFER-9106',
      value_usd: 1420000,
      weight_kg: 7100,
      deadline: new Date(now - 30 * 3600 * 1000),
      eta: new Date(now - 32 * 3600 * 1000),
      priority: 'critical' as const,
      requires_refrigeration: true,
      target_temp_min: 2.0,
      target_temp_max: 8.0,
    ...
    {
      shipment_id: 'SHP-CMP-9007',
      tracking_number: 'TRK-SG-2026-DEL-9007',
      title: 'Solar PV Bifacial Inverters & Arrays',
      origin_port_id: 'SGSIN',
      destination_port_id: 'INMUN',
      destination_name: 'Khavda Renewable Energy Park, Kutch',
      current_location: { lat: 23.8500, lng: 69.7500 },
      current_route_id: 'RTE-SIN-MUN-SEA',
      cargo_type: 'general' as const,
      cargo_description: 'High-efficiency industrial solar power conditioning units',
      container_id: 'CONT-DRY-9107',
      value_usd: 680000,
      weight_kg: 19500,
      deadline: new Date(now - 40 * 3600 * 1000),
      eta: new Date(now - 44 * 3600 * 1000),
      priority: 'medium' as const,
      requires_refrigeration: false,
      status: 'delivered' as const,
      risk_score: 0,
    ...
    {
      shipment_id: 'SHP-CMP-9008',
      tracking_number: 'TRK-SG-2026-DEL-9008',
      title: 'High-Purity Active Pharmaceutical Ingredients (API)',
      origin_port_id: 'AEJEA',
      destination_port_id: 'INNSA',
      destination_name: 'Dr. Reddy’s Laboratories Formulation Facility, Hyderabad',
      current_location: { lat: 17.3850, lng: 78.4867 },
      current_route_id: 'RTE-NSA-JEA-SEA',
      cargo_type: 'pharmaceuticals' as const,
      cargo_description: 'Sterile chemical precursors for cardiovascular formulation',
      container_id: 'CONT-REEFER-9108',
      value_usd: 1150000,
      weight_kg: 5400,
      deadline: new Date(now - 16 * 3600 * 1000),
      eta: new Date(now - 18 * 3600 * 1000),
      priority: 'high' as const,
      requires_refrigeration: true,
      target_temp_min: 2.0,
      target_temp_max: 8.0,
  ...
  sampleShipments.push(...deliveredShipments);
